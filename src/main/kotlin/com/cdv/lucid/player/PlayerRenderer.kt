...
object PlayerRenderer : Renderer {
    val sprite: Quad2D = Quad2D(width = 662f, height = 356f, scale = 100f, center = true).addTexture(TextureManager.loadTexture("tile_testing.png"))
    override fun render() {
        Camera.translate(Vector3f(Player.x, Player.y, 0f))
        sprite.draw()
    }
